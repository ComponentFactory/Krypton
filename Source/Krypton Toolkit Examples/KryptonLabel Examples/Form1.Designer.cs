namespace KryptonLabelExamples
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label4Professional = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.label3Professional = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.label5Professional = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.label2Professional = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.label1Professional = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.groupBox2 = new System.Windows.Forms.GroupBox();
            this.label3Custom = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.label2Custom = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            this.label1Custom = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
            ...
            // label1Professional
            // 
            this.label1Professional.LabelStyle = ComponentFactory.Krypton.Toolkit.LabelStyle.TitleControl;
            ...
            this.label3Custom.StateNormal.ShortText.ColorStyle = ComponentFactory.Krypton.Toolkit.PaletteColorStyle.Sigma;
        ...
        private ComponentFactory.Krypton.Toolkit.KryptonLabel label1Professional;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel label2Professional;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel label3Professional;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel label4Professional;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel label5Professional;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel label1Custom;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel label2Custom;
        private ComponentFactory.Krypton.Toolkit.KryptonLabel label3Custom;
