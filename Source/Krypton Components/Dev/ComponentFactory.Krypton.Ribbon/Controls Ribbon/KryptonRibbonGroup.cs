...
namespace ComponentFactory.Krypton.Ribbon
{
    ...
    [Designer("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupDesigner")]
    ...
    public class KryptonRibbonGroup : Component
    {
        ...
        [Editor("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupContainerCollectionEditor", typeof(UITypeEditor))]
