...
namespace ComponentFactory.Krypton.Ribbon
{
    ...
    public class RibbonAppButton : Storage
    {
        ...
        [Editor("ComponentFactory.Krypton.Toolkit.KryptonContextMenuItemCollectionEditor", typeof(UITypeEditor))]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        [Editor("ComponentFactory.Krypton.Ribbon.KryptonRibbonRecentDocCollectionEditor", typeof(UITypeEditor))]
