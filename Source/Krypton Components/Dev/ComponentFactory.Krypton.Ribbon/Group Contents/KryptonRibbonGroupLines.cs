...
namespace ComponentFactory.Krypton.Ribbon
{
    ...
    [Designer("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupLinesDesigner")]
    ...
    public class KryptonRibbonGroupLines : KryptonRibbonGroupContainer
    {
        ...
        [Editor("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupLinesCollectionEditor", typeof(UITypeEditor))]
