...
namespace ComponentFactory.Krypton.Ribbon
{
    ...
    [Designer("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupClusterDesigner")]
    ...
    public class KryptonRibbonGroupCluster : KryptonRibbonGroupContainer
    {
        ...
        [Editor("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupClusterCollectionEditor", typeof(UITypeEditor))]
