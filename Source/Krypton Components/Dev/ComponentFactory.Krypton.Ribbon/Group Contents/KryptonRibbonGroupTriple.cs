...
namespace ComponentFactory.Krypton.Ribbon
{
    ...
    [Designer("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupTripleDesigner")]
    ...
    public class KryptonRibbonGroupTriple : KryptonRibbonGroupContainer
    {
        ...
        [Editor("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupTripleCollectionEditor", typeof(UITypeEditor))]
