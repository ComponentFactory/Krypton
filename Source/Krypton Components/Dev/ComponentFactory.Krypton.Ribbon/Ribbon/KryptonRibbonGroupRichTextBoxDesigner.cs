        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonRichTextBox != null) && (_ribbonRichTextBox.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move RichTextBox First", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move RichTextBox Previous", ComponentFactory.Krypton.Ribbon.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move RichTextBox Next", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move RichTextBox Last", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteRichTextBoxMenu = new ToolStripMenuItem("Delete RichTextBox", ComponentFactory.Krypton.Ribbon.Properties.Resources.delete2, new EventHandler(OnDeleteTextBox));
