        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Cluster Button First", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Cluster Button Previous", ComponentFactory.Krypton.Ribbon.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Cluster Button Next", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Cluster Button Last", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteButtonMenu = new ToolStripMenuItem("Delete Cluster Button", ComponentFactory.Krypton.Ribbon.Properties.Resources.delete2, new EventHandler(OnDeleteButton));
