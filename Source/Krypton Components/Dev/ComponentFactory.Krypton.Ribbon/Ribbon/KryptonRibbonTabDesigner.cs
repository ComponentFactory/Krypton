        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
                 ...
                 _ribbonTab.Ribbon.RibbonTabs.Contains(_ribbonTab))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move First", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Previous", ComponentFactory.Krypton.Ribbon.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Next", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Last", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _addGroupMenu = new ToolStripMenuItem("Add Group", ComponentFactory.Krypton.Ribbon.Properties.Resources.KryptonRibbonGroup, new EventHandler(OnAddGroup));
                    _clearGroupsMenu = new ToolStripMenuItem("Clear Groups", null, new EventHandler(OnClearGroups));
                    _deleteTabMenu = new ToolStripMenuItem("Delete Tab", ComponentFactory.Krypton.Ribbon.Properties.Resources.delete2, new EventHandler(OnDeleteTab));
