        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
                 ...
                 _ribbonGroup.RibbonTab.Groups.Contains(_ribbonGroup))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Group First", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Group Previous", ComponentFactory.Krypton.Ribbon.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Group Next", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Group Last", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _moveToTabMenu = new ToolStripMenuItem("Move Group To Tab");
                    _addTripleMenu = new ToolStripMenuItem("Add Triple", ComponentFactory.Krypton.Ribbon.Properties.Resources.KryptonRibbonGroupTriple, new EventHandler(OnAddTriple));
                    _addLinesMenu = new ToolStripMenuItem("Add Lines", ComponentFactory.Krypton.Ribbon.Properties.Resources.KryptonRibbonGroupLines, new EventHandler(OnAddLines));
                    _addSeparatorMenu = new ToolStripMenuItem("Add Separator", ComponentFactory.Krypton.Ribbon.Properties.Resources.KryptonRibbonGroupSeparator, new EventHandler(OnAddSep));
                    _addGalleryMenu = new ToolStripMenuItem("Add Gallery", ComponentFactory.Krypton.Ribbon.Properties.Resources.KryptonGallery, new EventHandler(OnAddGallery));
                    _clearItemsMenu = new ToolStripMenuItem("Clear Items", null, new EventHandler(OnClearItems));
                    _deleteGroupMenu = new ToolStripMenuItem("Delete Group", ComponentFactory.Krypton.Ribbon.Properties.Resources.delete2, new EventHandler(OnDeleteGroup));
