        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonGallery != null) && (_ribbonGallery.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Gallery First", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Gallery Previous", ComponentFactory.Krypton.Ribbon.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Gallery Next", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Gallery Last", ComponentFactory.Krypton.Ribbon.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteGalleryMenu = new ToolStripMenuItem("Delete Gallery", ComponentFactory.Krypton.Ribbon.Properties.Resources.delete2, new EventHandler(OnDeleteGallery));
