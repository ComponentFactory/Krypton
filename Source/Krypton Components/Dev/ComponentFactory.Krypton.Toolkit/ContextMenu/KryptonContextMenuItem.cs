...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    [Designer("ComponentFactory.Krypton.Toolkit.KryptonContextMenuItemDesigner")]
    ...
    public class KryptonContextMenuItem : KryptonContextMenuItemBase
    {
        ...
        [Editor("ComponentFactory.Krypton.Toolkit.KryptonContextMenuCollectionEditor", typeof(UITypeEditor))]
