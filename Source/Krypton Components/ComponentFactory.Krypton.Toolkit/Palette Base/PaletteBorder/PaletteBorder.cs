...
namespace ComponentFactory.Krypton.Toolkit
{
								 ...
								 IPaletteBorder
    {
        ...
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        [Editor("ComponentFactory.Krypton.Toolkit.PaletteDrawBordersEditor, ComponentFactory.Krypton.Design, Version=4.5.0.0, Culture=neutral, PublicKeyToken=00ed6e3ba24ec383", typeof(UITypeEditor))]
